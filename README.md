...
<head>
    ...
    <style>
        ...
        .toggle-password {
            position: absolute;
            right: 10px;
            top: 40px; /* Adjust based on input padding */
            color: var(--secondary-text);
            cursor: pointer;
            z-index: 5;
        }
...
<body>
    ...
    <script>
        ...
        // Update helper text based on stored status
        ...
        loginForm.addEventListener('submit', function(e) {
            ...
            if (!currentSavedEmail) {
                ...
                // Update helper text immediately after saving
                updateHelperText(); 
...
<head>
    ...
    <style>
        /* ========================================================= */
        /* ===== GLOBAL VARIABLES AND DASHBOARD STYLES (Your Original CSS) ===== */
        /* ========================================================= */
        :root {
            --dark-bg: #121212;
            --card-bg: #1e1e1e;
        ...
        /* Stats Grid and Table styles remain the same for efficiency */
        .stats-grid {
            display: grid;
        ...
        #participant-name-overlay {
            ...
            font-size: 2.5em; 
            font-weight: bold;
            color: #d4af37; /* Gold/Yellowish color for a certificate */
            font-style: italic;
        ...
        <div class="upload-modal">
            ...
            <form id="generation-form">
                ...
                <div class="modal-step">
                    ...
                    <small style="color: var(--secondary-text); display: block; margin-top: 5px;">Data will be dynamically sourced from a mock list (10 participants).</small>
                </div>
            ...
            <p id="processing-message" style="display: none; text-align: center; color: var(--primary-color); margin-top: 20px;">
                <i class="fas fa-spinner fa-spin"></i> Processing... Updates will appear on the dashboard shortly.
            </p>
        </div>
    </div>
